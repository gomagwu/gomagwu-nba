...
def playoff(home, away, year, conf, mod, post):
    PO = {
        'season': [year, year, year, year, year, year, year],
        'team1': [home, home, away, away, home, away, home],
        'team2': [away, away, home, home, away, home, away],
        'quality': [45, 45, 45, 45, 45, 45, 45],  ##Average Quality of all games
        'Location': [1, 1, 1, 1, 1, 1, 1],  ##team1 plays at home
...
mod = joblib.load('mod_joblib')
log = joblib.load('log_joblib')
